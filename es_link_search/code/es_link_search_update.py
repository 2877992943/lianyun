...
if __name__ == "__main__":
    ...
    print 'insert'
    es.index(index="yunkecn",doc_type="clue",id='42',body={'feature_value':{'1':1,'2':2}})
    es.delete(index="yunkecn",doc_type="clue",id='42',params=)


    print 'search'
    res=es.get(index="yunkecn",doc_type="clue",id='42')['_source']
    print res,res['feature_value']

    print 'update'
    body={'doc':{'feature_value':{ u'13': 1, u'38': 1, u'16': 1} } }
    es.update(index="yunkecn",doc_type="clue",id='42',body=body)
    es.indices.refresh(index="yunkecn")

    print 'search'
    res=es.get(index="yunkecn",doc_type="clue",id='42')['_source']
    print res['feature_value']
    res=es.get(index="yunkecn",doc_type="clue",id='04323D70B06544FE9187181D50B573B3')['_source']
    print res['feature_value']
