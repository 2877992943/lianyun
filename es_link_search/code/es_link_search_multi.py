...
if __name__ == "__main__":
    ...
    for hit in hits[:]:
        ...
        #for k,v in hit.items():
         #   print k,v
        #print hit.keys()
        if len(hit['main_produce'])>10:
            print hit['main_produce']
            print hit['main_industry']
            print hit['feature_value']
            print hit['param4'],hit['param5']
