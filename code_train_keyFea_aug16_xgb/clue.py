...
# class com_info(CategoricalTextMixIn, ClueFeature):
#     extract_tags=True
#     name = 'clueTable_com_info'
#     field_name = 'com_info'
#     vocabulary = {}
#     vocabulary_size = 0

# class com_name(CategoricalTextMixIn,ClueFeature):
#     name = 'clueTable_com_name'
#     field_name = 'Clue_Entry_Com_Name'
#     vocabulary = {}
#     vocabulary_size = 0
