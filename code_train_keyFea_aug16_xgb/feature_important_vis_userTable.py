...
from base import CategoricalTextMixIn, ClueFeature, FieldExistsMixIn, ParseNumberMixIn,get_clues,get_users
import pylab as plt
import sys
reload(sys)
...
if __name__ == "__main__":
    ...
    model_clueid=uid_list

    from base import UserFeature
    from user import *
    features = UserFeature.__subclasses__();print features
    from generate_clueUser_clue import gen_svmlight



    ret=get_users(uid_list)

    gen_svmlight('../modeling_16w_userTable', features, uid_list,'user')#generate {cid:strFea...}
